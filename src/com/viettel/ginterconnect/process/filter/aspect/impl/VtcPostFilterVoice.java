 ...
 * @author ubuntu
 */
public class VtcPostFilterVoice implements IFilterAspectFunction {
    ...
    public void filterAspectFunction(JobsBO currentJob, Object mapOutput) throws FilterException {
        try {
            ...
            if (!mapNewRevenue.isEmpty()) {
                GIClient.getInstance().mergeRevenueDailyAndMonthly(mapNewRevenue, "VTC");
            }
        } catch (Exception ex) {
            throw ex;
        }
