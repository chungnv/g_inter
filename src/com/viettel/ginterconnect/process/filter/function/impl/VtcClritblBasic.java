 ...
 * @author ubuntu
 */
public class VtcClritblBasic implements IFunction {

    @Override
    public Object execute(CdrObject object, String inputField, String params, String fieldParams, Object filterCache, Logger logger) {
        //(case when Account_Type1 in('2004','2000') then cast(Cleaned_Amount1 as double) else 0.0 end)
        //+(case when Account_Type2 in('2004','2000') then cast(Cleaned_Amount2 as double) else 0.0 end)
        //+(case when Account_Type3 in('2004','2000') then cast(Cleaned_Amount3 as double) else 0.0 end)
        //+(case when Account_Type4 in('2004','2000') then cast(Cleaned_Amount4 as double) else 0.0 end)
        Double val = 0.0;
        if (object.get("Account_Type1") != null && ("2000".equals(object.get("Account_Type1").toString()) 
                || "2004".equals(object.get("Account_Type1").toString()))) {
        ...
        if (object.get("Account_Type2") != null && ("2000".equals(object.get("Account_Type2").toString()) 
                || "2004".equals(object.get("Account_Type2").toString()))) {
        ...
        if (object.get("Account_Type3") != null && ("2000".equals(object.get("Account_Type3").toString()) 
                || "2004".equals(object.get("Account_Type3").toString()))) {
        ...
        if (object.get("Account_Type4") != null && ("2000".equals(object.get("Account_Type4").toString()) 
                || "2004".equals(object.get("Account_Type4").toString()))) {
