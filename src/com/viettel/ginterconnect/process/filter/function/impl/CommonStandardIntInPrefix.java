...
import com.viettel.ginterconnect.cached.CommonIntInPrefixCache;
 ...
 * @author ubuntu
 */
public class CommonStandardIntInPrefix implements IFunction {
    ...
    public Object execute(CdrObject object, String inputField, String params, String fieldParams, Object filterCache, Logger logger) throws Exception {
        ...
        Long partnerId = object.getLong("TRUNK_IN_PARTNER_ID", "SMS_IN_PARTNER_ID");
        if (isCallingNational != 1 || partnerId == null) {
            return object;
        }
        String calling = object.getString("CALLING");
        try {
            CommonIntInPrefixCache stlIntInPrefixCache = (CommonIntInPrefixCache) ThreadCached.initCache("CommonIntInPrefixCache", fieldParams, params);
