...
public class VtcRecIsdn implements IFunction {
    ...
    public Object execute(CdrObject object, String inputField, String params, String fieldParams, Object filterCache, Logger logger) {
        ...
        if (object.get("SERVICE_FLOW") != null &&
                "3".equals(object.get("SERVICE_FLOW"))) {
            isdn = object.get("CALLING_PARTY_NUMBER").toString();
            return isdn;
        }
        if (object.get("CALLING_PARTY_NUMBER") != null && object.get("CALLING_PARTY_NUMBER").toString().length() > 3) {
