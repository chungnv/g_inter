 ...
 * @author viettq
 */
public class VtcCalledSms implements IFunction {
	...
	public Object execute(CdrObject object, String inputField, String params, String fieldParams, Object filterCache, Logger logger) {
		...
		else if ((object.containsProperty("SMS_TYPE") && object.get("SMS_TYPE") != null)
				&& (object.containsProperty("CALLED_PARTY_NUMBER") && object.get("CALLED_PARTY_NUMBER") != null)) {
			if ("3".equals(object.get("SMS_TYPE"))) {
				return object.get("CALLED_PARTY_NUMBER");
			}
		}
		else if ((object.containsProperty("SMS_TYPE") && object.get("SMS_TYPE") != null)
				&& (object.containsProperty("CALLED_PARTY_NUMBER") && object.get("CALLED_PARTY_NUMBER") != null)) {
			if (!("3".equals(object.get("SMS_TYPE"))) && !called.startsWith("855")) {
				return object.get("CALLED_PARTY_NUMBER");
			}
