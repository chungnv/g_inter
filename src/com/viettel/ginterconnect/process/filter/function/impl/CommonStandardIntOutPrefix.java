...
import com.viettel.ginterconnect.cached.CommonIntOutPrefixCache;
 ...
 * @author ubuntu
 */
public class CommonStandardIntOutPrefix implements IFunction {
    ...
    public Object execute(CdrObject object, String inputField, String params, String fieldParams, Object filterCache, Logger logger) throws Exception {
        Long isCallingNational = object.getLong("TRUNK_OUT_IS_NATIONAL", "SMS_OUT_IS_NATIONAL");
        Long partnerId = object.getLong("TRUNK_OUT_PARTNER_ID", "SMS_OUT_PARTNER_ID");
        if (isCallingNational != 1 || partnerId == null) {
            return object;
        }
        String called = object.getString("CALLED");
        try {
            CommonIntOutPrefixCache stlIntOutPrefixCache = (CommonIntOutPrefixCache) ThreadCached.initCache("CommonIntOutPrefixCache", fieldParams, params);
