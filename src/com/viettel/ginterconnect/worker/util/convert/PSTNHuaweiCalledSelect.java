 ...
 * @author chungdq
 */
public class PSTNHuaweiCalledSelect extends BaseFunction{

    /**
     * return Digits String
     * args[0]: Direction Ex: O,I,T
     * args[1]: Called DNSEt Ex: 0,1,2
     * args[2]: Called Number
     * args[3]: map
     */
    @Override
    public Object calculate(Object... args) throws Exception {
        ...
        if (args[0] != null && args[0].toString().equals("I") && args[1] != null && args[3] != null && args[3] instanceof Map)
        {
