 ...
 * @author chungdq
 */
public class CdrHwPSTNCallType extends BaseCdrField
{
     ...
     * @param description
     */
    public CdrHwPSTNCallType(int length, String description)
    {
     ...
     * @param bitPos
     */
    public CdrHwPSTNCallType(int length, String description, int bitPos)
    {
        super(length, description);
        this.bitPos = bitPos;
    }
    ...
    protected Object unpackDetail(byte[] b, int offset) throws Exception
    {
        ...
        {
            bits[i] = (byte) ((b[offset] & (1 << i)) != 0 ? 1 : 0);
        }
