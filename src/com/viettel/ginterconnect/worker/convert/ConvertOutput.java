...
public class ConvertOutput {
     ...
     */
    public ConvertOutput(String fileName) throws IOException {
        init(fileName, DEFAULT_SEPARATE_CHARACTER);
    }

    public ConvertOutput(String fileName, boolean append) throws IOException {
     ...
     * @throws java.io.IOException
     */
    public ConvertOutput(String fileName, String separateChar) throws IOException {
        this.filename = fileName;
        init(fileName, separateChar);
    }

    public ConvertOutput(String fileName, String separateChar, boolean append) throws IOException {
