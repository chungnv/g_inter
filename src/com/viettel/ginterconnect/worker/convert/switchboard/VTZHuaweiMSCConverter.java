...
import com.viettel.ginterconnect.worker.util.convert.vtz.ASNUtil;
import com.viettel.ginterconnect.worker.util.convert.vtz.BaseCdrField;
import com.viettel.ginterconnect.worker.util.convert.vtz.ByteArrayUtil;
import com.viettel.ginterconnect.worker.util.convert.vtz.CdrBits;
import com.viettel.ginterconnect.worker.util.convert.vtz.CdrChars;
import com.viettel.ginterconnect.worker.util.convert.vtz.CdrHuaweiLastLocation;
import com.viettel.ginterconnect.worker.util.convert.vtz.CdrHuaweiLocation;
import com.viettel.ginterconnect.worker.util.convert.vtz.CdrNumeric;
import com.viettel.ginterconnect.worker.util.convert.vtz.HuaweiRecord;
import com.viettel.ginterconnect.worker.util.convert.vtz.ParamFileUtil;
import com.viettel.ginterconnect.worker.util.convert.vtz.TLVLengthType;
import com.viettel.ginterconnect.worker.util.convert.vtz.VTZCdrBitString;
import com.viettel.ginterconnect.worker.util.convert.vtz.VTZCdrHEXByteString;
import com.viettel.ginterconnect.worker.util.convert.vtz.WriteItem;
import com.viettel.ginterconnect.worker.util.convert.vtz.WriteItemField;
import com.viettel.ginterconnect.worker.util.convert.vtz.WriteItemFixField;
import com.viettel.ginterconnect.worker.util.convert.vtz.WriteItemFunction;
import com.viettel.ginterconnect.worker.util.convert.vtz.WriteItemMap;
...
/**
 *
 * @author kienpv File convert cho HuaweiMSC va huawei GMSC
 */
public class VTZHuaweiMSCConverter extends BaseConverter {
...
//            if ((typeMap.get(obj.getTagTypeInt()).toString()).equals("CallType")) {
//                BaseCdrField chars = new NCdrCallType((int) obj.getLength() - 1, separate);
//                ColumArr[(int) indexMap.get(obj.getTagTypeInt()) - 1] =
...
//            if ((typeMap.get(obj.getTagTypeInt()).toString()).equals("Location")) {
//                BaseCdrField chars = new CdrHuaweiLocationLU((int) obj.getLength(), separate);
//                ColumArr[(int) indexMap.get(obj.getTagTypeInt()) - 1] =
//                        chars.unpack(mBuffer, mintIndex + 1).toString();
//            }
            ...
            if ((typeMap.get(obj.getTagTypeInt()).toString()).contains("Sequence")) {
                ...
                ColumArr[(int) indexMap.get(obj.getTagTypeInt()) - 1]
                        = ASNUtil.formatSequence(dateFormat, mBuffer, mintIndex + 1,
                                (int) obj.getLength(), seqTypeInt, pattern);
            ...
            if ((typeMap.get(obj.getTagTypeInt()).toString()).equals("BitString")) {
                BaseCdrField chars = new VTZCdrBitString((int) obj.getLength(), separate);
                ColumArr[(int) indexMap.get(obj.getTagTypeInt()) - 1]
                        = chars.unpack(mBuffer, mintIndex + 1).toString();
            }
            ...
            if ((typeMap.get(obj.getTagTypeInt()).toString()).equals("HEXByteString")) {
                BaseCdrField chars = new VTZCdrHEXByteString((int) obj.getLength(), separate);
                ColumArr[(int) indexMap.get(obj.getTagTypeInt()) - 1]
                        = chars.unpack(mBuffer, mintIndex + 1).toString();
            }
